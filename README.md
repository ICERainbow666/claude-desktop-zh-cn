...
|---------|------|----------|---------------|---------|
| **1.15200.0.0** | 2026-06-25 | 16,247 / 16,980 | 419 / 428 | 46 / 46 |
| 1.14271.0.0 | 未知 | 16,345 / 16,625 | 424 / 424 | 46 / 46 |
| 1.13576.0.0 | 未知 | 16,224 / 16,500 | 428 / 428 | 46 / 46 |
| 1.12603.1.0 | 未知 | 15,892 / 16,178 | 420 / 425 | 69 / 69 |
...
脚本会根据 Claude Desktop 版本自动判断是否需要硬编码补丁；新版本仅安装语言包，旧版本会额外处理硬编码字符串。
